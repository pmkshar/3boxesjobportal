  ...
  _courses = [
    {
      ...
      description: 'Master AI and Machine Learning with step-wise lessons, AI voice tutoring, graded quizzes, and video walkthroughs. Covers neural networks, deep learning, NLP, computer vision, and model deployment with hands-on projects and verified certificate.',
      category: 'Data Science',
      level: 'all',
      duration: 40,
      skills: 'Python, TensorFlow, PyTorch, Machine Learning, Deep Learning, NLP, Computer Vision, MLOps',
      instructor: 'MarqAI Courses',
      rating: 4.9,
      enrollCount: 3200,
      isActive: true,
      price: 16616.50,
      priceCurrency: 'INR',
      sourceUrl: 'https://marqaicourses.com',
      createdAt: new Date().toISOString(),
    },
    {
      id: 'fullstack-java-development',
      title: 'Full Stack Java Development',
      description: 'Build end-to-end web applications with Java, Spring Boot, Hibernate, and React. Learn REST API design, microservices architecture, database management, and deployment with AI voice tutoring and verified certificate.',
      category: 'Programming',
      level: 'intermediate',
      duration: 48,
      skills: 'Java, Spring Boot, Hibernate, REST API, Microservices, React, MySQL, Docker',
      instructor: 'MarqAI Courses',
      rating: 4.8,
      enrollCount: 2800,
      isActive: true,
    ...
    },
    {
      ...
      description: 'Master full-stack development with .NET, C#, ASP.NET Core, and Azure. Build enterprise-grade applications with step-wise lessons, AI voice tutoring, graded tests, and verified certificate.',
      category: 'Programming',
      level: 'intermediate',
      duration: 45,
      skills: 'C#, ASP.NET Core, Entity Framework, Azure, SQL Server, REST API, Blazor, Docker',
      instructor: 'MarqAI Courses',
      rating: 4.8,
      enrollCount: 2200,
      isActive: true,
    ...
    },
    {
      ...
      description: 'Build cross-platform mobile applications with React Native. Covers iOS & Android deployment, state management, native modules, and app store publishing with AI voice tutoring and verified certificate.',
      category: 'Programming',
      level: 'intermediate',
      duration: 36,
      skills: 'React Native, JavaScript, TypeScript, Redux, iOS, Android, Firebase, App Store Deployment',
      instructor: 'MarqAI Courses',
      rating: 4.7,
      enrollCount: 1900,
      isActive: true,
    ...
    },
    {
      ...
      description: 'Build beautiful cross-platform apps with Flutter and Dart. Learn state management, REST APIs, native integrations, and deployment with AI voice tutoring, graded quizzes, and verified certificate.',
      category: 'Programming',
      level: 'all',
      duration: 32,
      skills: 'Flutter, Dart, State Management, REST API, Firebase, iOS, Android, App Deployment',
      instructor: 'MarqAI Courses',
      rating: 4.8,
      enrollCount: 2100,
      isActive: true,
    ...
    },
    {
      ...
      description: 'Comprehensive Python course from fundamentals to advanced concepts. Covers data structures, OOP, web development with Django/Flask, automation, data science basics with AI voice tutoring and verified certificate.',
      category: 'Programming',
      level: 'all',
      duration: 35,
      skills: 'Python, Django, Flask, OOP, Data Structures, Automation, Pandas, NumPy',
      instructor: 'MarqAI Courses',
      rating: 4.9,
      enrollCount: 3500,
      isActive: true,
    ...
    },
    {
      ...
      description: 'Develop essential workplace communication, leadership, presentation, and collaboration skills. Learn interview techniques, email etiquette, and professional networking with AI voice tutoring and verified certificate.',
      category: 'Soft Skills',
      level: 'all',
      duration: 20,
      skills: 'Communication, Leadership, Presentation, Interview Skills, Email Etiquette, Networking, Teamwork',
      instructor: 'MarqAI Courses',
      rating: 4.8,
      enrollCount: 1600,
      isActive: true,
    ...
    },
    {
      ...
      description: 'Exclusive curated course for 3Boxes platform developers. Covers the full tech stack, best practices, deployment workflows, and integration patterns with AI voice tutoring and verified certificate. Free for 3Boxes developers.',
      category: 'Programming',
      level: 'intermediate',
      duration: 30,
      skills: 'Full Stack, React, Node.js, Next.js, PostgreSQL, Vercel, Git, CI/CD',
      instructor: 'MarqAI Courses',
      rating: 4.9,
      enrollCount: 980,
      isActive: true,
