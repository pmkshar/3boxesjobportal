...
export function LandingPage({ onNavigate }: { onNavigate: (view: string) => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#014217] overflow-x-hidden">
      {/* ===== NAVBAR ===== */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-24">
            ...
            <div className="hidden lg:flex items-center gap-6 text-sm text-[#014217]/80">
              <a href="#jobs" className="hover:text-[#014217] font-medium transition-colors">Find Jobs</a>
              <a href="#companies" className="hover:text-[#014217] font-medium transition-colors">Companies</a>
              <a href="#ai-features" className="hover:text-[#014217] font-medium transition-colors">AI Features</a>
              <a href="#training" className="hover:text-[#014217] font-medium transition-colors">Training</a>
            </div>
            {/* Right: Auth buttons */}
              ...
              <div className="flex-1 px-6 py-6">
                {authView === 'login' ? (
                  ...
                  <div className="space-y-5">
                    ...
                    <Button className="w-full h-11 bg-[#014217] hover:bg-[#066722] text-white font-semibold rounded-xl text-sm"
                    ...
                    <div className="rounded-xl border border-gray-100 bg-gray-50/50 p-4 space-y-2">
                      <p className="text-xs font-semibold text-gray-600 mb-3 flex items-center gap-1.5">
                        <Sparkles className="h-3.5 w-3.5 text-[#014217]" /> Try any role instantly:
                      </p>
                      <div className="grid grid-cols-2 gap-2">
                        {Object.entries(credentials).map(([role, cred]) => (
                          <button key={role} onClick={() => fillDemo(role as DemoRole)}
                            ...
                            <Lock className="h-3.5 w-3.5 shrink-0 text-[#014217]" />
                    ...
                    <div className="text-center text-sm text-gray-500 mt-4">
                      ...
                      <button onClick={() => setAuthView('register')} className="font-semibold text-[#014217] hover:underline">Sign up free</button>
                    </div>
                  </div>
                ) : (
                  /* ===== REGISTER FORM ===== */
                  <div className="space-y-5">
                        ...
                        {[
                          ...
                          <Card key={role.value}
                            ...
                            <CardContent className="p-3 text-center">
                              <role.icon className={`h-5 w-5 mx-auto mb-1 ${regRole === role.value ? 'text-[#014217]' : 'text-gray-400'}`} />
                              <div className={`text-xs font-medium ${regRole === role.value ? 'text-[#014217]' : 'text-gray-600'}`}>{role.label}</div>
                            </CardContent>
                          </Card>
                        ))}
                      </div>
                    ...
                    <div className="text-center text-sm text-gray-500">
                      ...
                      <button onClick={() => setAuthView('login')} className="font-semibold text-[#014217] hover:underline">Sign in</button>
                    </div>
                  </div>
                )}
              </div>
      ...
      {/* ===== HERO SECTION ===== */}
      <section className="relative bg-gradient-to-br from-[#014217] via-[#066722] to-[#22c55e] pb-20 sm:pb-28 pt-6 overflow-hidden">
              ...
              >
                <div className="bg-white rounded-2xl shadow-2xl p-2 sm:p-3">
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <Button className="h-12 px-8 bg-[#014217] hover:bg-[#066722] text-white font-semibold text-base rounded-xl whitespace-nowrap shadow-md"
            ...
            >
              <div className="relative">
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-2 border-white/10">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#014217]/80 via-transparent to-transparent" />
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[#f26405]/15 flex items-center justify-center">
                      <Trophy className="h-5 w-5 text-[#f26405]" />
                    </div>
                    <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[#014217]/15 flex items-center justify-center">
                      <Brain className="h-5 w-5 text-[#014217]" />
                    </div>
                    <div>
                  ...
                  <Card className={`cursor-pointer hover:shadow-md transition-all border ${cat.color} group`}
                    ...
                    <CardContent className="p-4 flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center flex-shrink-0 shadow-sm group-hover:scale-110 transition-transform">
                        <cat.icon className="h-5 w-5 text-[#014217]" />
                      </div>
      ...
      {showSearchResults && (
        <section className="py-12 bg-[#014217]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl sm:text-2xl font-extrabold text-gray-900">
                Search Results {searchResults.length > 0 && <span className="text-[#014217]">({searchResults.length})</span>}
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {searchResults.map((job: any, i: number) => (
                  <motion.div key={job.id} initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: i * 0.04 }}>
                    <Card className={`hover:shadow-lg transition-all cursor-pointer border-gray-100 group ${selectedJob?.id === job.id ? 'ring-[#014217] border-[#014217]' : 'hover:border-emerald-200'}`}
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-bold text-gray-900 text-sm leading-tight group-hover:text-[#014217] transition-colors line-clamp-2">{job.title}</h3>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-gray-50">
                          ...
                          <span className="text-xs font-medium text-[#014217] flex items-center gap-0.5 group-hover:text-emerald-700">
      ...
      <section id="jobs" className="py-16 bg-[#013b0b]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <Button variant="ghost" className="text-[#014217] text-sm font-semibold" onClick={isAuthenticated ? undefined : openLogin}>
              View All <ChevronRight className="h-4 w-4 ml-1" />
            </Button>
          </div>
          {jobs.length === 0 ? (
                  ...
                  <Card className="hover:-translate-y-1 transition-all duration-300 cursor-pointer group border-0 shadow-sm hover:shadow-xl overflow-hidden"
                    ...
                    <CardContent className="p-0">
                      ...
                      <div className={`relative h-[120px] ${getCompanyColor(job.corporate?.companyName)} flex items-center justify-center overflow-hidden`}>
                        ...
                        {job.isRemote && (
                          <label className="absolute top-3 left-3 bg-[#f26405] text-white text-[9px] font-semibold px-2 py-0.5 rounded-md uppercase tracking-wide shadow-sm">
                            Remote
                          </label>
                        )}
                        {i < 3 && !job.isRemote && (
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center gap-3 text-[11px] text-gray-500 mb-3">
                          <span className="flex items-center gap-1">
                            <Clock className="h-3 w-3 text-[#014217]" />
                            {job.postedDate ? timeAgo(job.postedDate) : 'Recently'}
                          </span>
                          <span className="flex items-center gap-1">
                            <MapPin className="h-3 w-3 text-[#014217]" />
                            {job.location || 'Remote'}
                          </span>
                        </div>
                        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                          ...
                          <ChevronRight className="h-4 w-4 text-gray-400 group-hover:text-[#014217] group-hover:translate-x-0.5 transition-all" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <div className="fixed inset-0 z-50 bg-white overflow-y-auto">
          ...
          <div className="sticky top-0 z-10 bg-gradient-to-r from-[#014217] to-[#066722] py-3 px-4 sm:px-6 shadow-lg">
            <div className="max-w-7xl mx-auto flex items-center gap-3">
              ...
              <Button className="bg-[#f26405] hover:bg-[#e85a05] text-[#202124] font-semibold h-9 px-5 shadow-md" onClick={() => {
          ...
          <section className="relative bg-gradient-to-r from-[#014217] to-[#066722] pb-8 pt-4 overflow-hidden">
                  ...
                  <Card className="border-[#ecedf2]">
                    <CardContent className="p-6">
                      ...
                      <div className="flex gap-3">
                        <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#014217] text-white text-sm font-medium hover:opacity-90 transition-opacity"><Facebook className="h-4 w-4" /> Facebook</button>
                        <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#066722] text-white text-sm font-medium hover:opacity-90 transition-opacity"><Twitter className="h-4 w-4" /> Twitter</button>
                ...
                <div className="space-y-6">
                      ...
                      <CardContent className="p-5">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedJob.skills.split(',').map((s: string) => (
                            <Badge key={s.trim()} className="bg-[#f5f7fc] text-[#5f6368] border border-[#ecedf2] hover:bg-[#f0f8f0] hover:text-[#014217] rounded-md px-3 py-1.5 text-sm font-normal transition-colors">{s.trim()}</Badge>
                          ))}
                        </div>
                      </CardContent>
                    </Card>
                  ...
                  <Card className="border-[#ecedf2] bg-gradient-to-br from-[#014217] to-[#066722]">
                    <CardContent className="p-5 text-center">
                      ...
                      <Button className="w-full bg-[#f26405] hover:bg-[#e85a05] text-[#202124] font-semibold h-11 shadow-md" onClick={() => {
                        if (!isAuthenticated) { openLogin() } else { toast.success('Application feature available in dashboard') }
                      }}>
                        Apply For This Job
                      </Button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <motion.div initial={{ y: 10, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }}>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Companies That <span className="text-[#014217]">Hire Through Us</span></h2>
            ...
            <div className="overflow-hidden">
              <div className="flex gap-6 animate-marquee whitespace-nowrap">
                {[...topCompanies, ...topCompanies, ...topCompanies].map((c, i) => (
                  <div key={`${c.name}-${i}`} className="flex-shrink-0 w-[130px] h-[70px] flex items-center justify-center rounded-xl border border-gray-100 bg-gray-50 hover:border-[#014217]/30 hover:bg-[#f0f8f0] transition-all group">
                    <div className="flex items-center gap-2">
          ...
          <div className="mt-4">
            <h3 className="text-xl font-bold text-gray-900 text-center mb-8">Why Corporates Choose <span className="text-[#014217]">3 Boxes</span></h3>
            ...
            <div className="text-center mt-10">
              <Button className="bg-[#014217] hover:bg-[#066722] text-white font-semibold px-8 h-12 text-base rounded-xl shadow-md" onClick={openRegister}>
      ...
      <section id="ai-features" className="py-16 bg-[#014217]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <motion.div initial={{ y: 10, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }}>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Built-In <span className="text-[#014217]">AI Features</span> for Every User</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0 }} viewport={{ once: true }}>
              <Card className="border-0 shadow-sm h-full overflow-hidden">
                <div className="bg-gradient-to-br from-[#014217] to-[#066722] p-6 text-center relative">
            ...
            <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.15 }} viewport={{ once: true }}>
              <Card className="border-0 shadow-sm h-full overflow-hidden">
                <div className="bg-gradient-to-br from-[#f26405] to-[#e85a05] p-6 text-center relative">
                  <div className="absolute inset-0 opacity-10" style={{backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'20\' height=\'20\' viewBox=\'0 0 20 20\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'%23ffffff\' fill-opacity=\'0.3\' fill-rule=\'evenodd\'%3E%3Ccircle cx=\'3\' cy=\'3\' r=\'1.5\'/%3E%3C/g%3E%3C/svg%3E")'}} />
            ...
            <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.3 }} viewport={{ once: true }}>
              <Card className="border-0 shadow-sm h-full overflow-hidden">
                <div className="bg-gradient-to-br from-[#066722] to-[#014217] p-6 text-center relative">
                  <div className="absolute inset-0 opacity-10" style={{backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'20\' height=\'20\' viewBox=\'0 0 20 20\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'%23ffffff\' fill-opacity=\'0.3\' fill-rule=\'evenodd\'%3E%3Ccircle cx=\'3\' cy=\'3\' r=\'1.5\'/%3E%3C/g%3E%3C/svg%3E")'}} />
          ...
          <div className="mt-12">
            <h3 className="text-xl font-bold text-gray-900 text-center mb-8">How <span className="text-[#014217]">AI</span> Powers Your Hiring Journey</h3>
      ...
      <section id="training" className="py-16 bg-[#014217]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }}>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight">
                Training That <span className="text-[#014217]">Auto-Updates</span> Your Profile
              </h2>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a href="https://marqaitrainers.vercel.app/" target="_blank" rel="noopener noreferrer">
                  <Button className="bg-[#014217] hover:bg-[#066722] text-white font-semibold px-6 h-11 rounded-xl shadow-md">
                    <GraduationCap className="h-5 w-5 mr-2" /> Explore Training Portal
                  </Button>
                </a>
                <Button variant="outline" className="border-[#014217] text-[#014217] hover:bg-[#f0f8f0] font-semibold px-6 h-11 rounded-xl" onClick={openRegister}>
