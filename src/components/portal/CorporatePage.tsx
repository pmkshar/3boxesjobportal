  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Hire Smarter with <span className="text-[#04a331]">AI-Powered</span> Recruitment
            </h1>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-8 text-white">
              {[
                ...
                <div key={i} className="text-center">
                  ...
                  <div className="text-[#b0d9b5]/70 text-xs mt-0.5">{stat.label}</div>
                </div>
              ))}
            </div>
          </motion.div>
            ...
            <div className="overflow-hidden">
              <div className="flex gap-6 animate-marquee whitespace-nowrap">
                {[...topCompanies, ...topCompanies, ...topCompanies].map((c, i) => (
                  <div key={`${c.name}-${i}`} className="flex-shrink-0 w-[130px] h-[70px] flex items-center justify-center rounded-xl border border-gray-100 bg-white hover:border-[#014217]/30 hover:bg-[#f0f8f0] transition-all group shadow-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <motion.div initial={{ y: 10, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }}>
              <Badge className="bg-[#f0f8f0] text-[#014217] border-[#d8ecd8] rounded-full px-4 py-1 text-xs font-semibold mb-3">Recruitment Workflow</Badge>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Why Corporates Choose <span className="text-[#014217]">3 Boxes</span></h2>
      ...
      <section className="py-16 bg-[#f5f7fc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Complete <span className="text-[#014217]">Hiring Solution</span></h2>
                ...
                <Card className="border-0 shadow-sm h-full hover:shadow-md transition-all">
                  <CardContent className="p-6">
                    <div className="w-12 h-12 rounded-xl bg-[#f0f8f0] flex items-center justify-center mb-4">
                      <benefit.icon className="h-6 w-6 text-[#014217]" />
                    </div>
      ...
      <section className="py-16 bg-gradient-to-br from-[#014217] via-[#066722] to-[#22c55e] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#d8ecd8]/80 mt-3 text-base max-w-xl mx-auto">Join 500+ companies that have already streamlined their recruitment with 3 Boxes AI-powered platform. Start posting jobs for free today.</p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Button className="bg-[#f26405] hover:bg-[#04a331] text-green-900 font-bold px-8 h-12 text-base rounded-xl shadow-lg">
              <Building2 className="h-5 w-5 mr-2" /> Register Your Company
            </Button>
            <p className="text-[#b0d9b5]/70 text-sm">Free to post. Pay only when you hire.</p>
          </div>
        </div>
      </section>
    </div>
