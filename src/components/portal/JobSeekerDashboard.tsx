...
function BankIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="flex-shrink-0">
      ...
      <path d="M12 24h16M12 20h16M12 16h16" stroke="#f26405" strokeWidth="2" strokeLinecap="round"/>
      <circle cx="20" cy="12" r="2" fill="#f26405"/>
      <path d="M14 28v-4M20 28v-4M26 28v-4" stroke="#f26405" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  )
}
function LampIcon() {
