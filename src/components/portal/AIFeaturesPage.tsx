...
export function AIFeaturesPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* ===== HERO BANNER ===== */}
      <section className="relative bg-gradient-to-br from-[#014217] via-[#066722] to-[#22c55e] py-16 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Built-In <span className="text-[#04a331]">AI Features</span> for Every User
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="bg-[#f0f8f0] text-[#014217] border-[#d8ecd8] rounded-full px-4 py-1 text-xs font-semibold mb-3">Tailored AI Tools</Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">AI Features <span className="text-[#014217]">For Your Role</span></h2>
      ...
      <section className="py-16 bg-[#f5f7fc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="bg-[#f0f8f0] text-[#014217] border-[#d8ecd8] rounded-full px-4 py-1 text-xs font-semibold mb-3">AI Workflow</Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">How <span className="text-[#014217]">AI</span> Powers Your Hiring Journey</h2>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="border-0 shadow-sm h-full">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#014217] to-[#066722] flex items-center justify-center">
            ...
            <motion.div initial={{ x: 20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }}>
              <Card className="border-0 shadow-sm h-full">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#f26405] to-[#e85a05] flex items-center justify-center">
                  ...
                  <div className="space-y-2">
                    {['Role-specific question generation', 'Communication analysis & scoring', 'Technical depth evaluation', 'Real-time behavioral feedback', 'Comprehensive interview reports'].map((item, i) => (
                      <div key={i} className="flex items-center gap-2 text-sm">
                        <CheckCircle2 className="h-4 w-4 text-[#f26405] flex-shrink-0" />
                        <span className="text-gray-600">{item}</span>
                      </div>
                    ))}
                  </div>
      ...
      {/* ===== CTA SECTION ===== */}
      <section className="py-16 bg-gradient-to-br from-[#014217] via-[#066722] to-[#22c55e] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Button className="bg-[#f26405] hover:bg-[#04a331] text-green-900 font-bold px-8 h-12 text-base rounded-xl shadow-lg">
              Get Started Free
            </Button>
          </div>
        </div>
