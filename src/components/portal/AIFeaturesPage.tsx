  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Built-In <span className="text-[#49A842]">AI Features</span> for Every User
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="bg-[#e8f5e9] text-[#1f8f15] border-[#c8e6c9] rounded-full px-4 py-1 text-xs font-semibold mb-3">Tailored AI Tools</Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">AI Features <span className="text-[#1f8f15]">For Your Role</span></h2>
      ...
      <section className="py-16 bg-[#f5f7fc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="bg-[#e8f5e9] text-[#1f8f15] border-[#c8e6c9] rounded-full px-4 py-1 text-xs font-semibold mb-3">AI Workflow</Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">How <span className="text-[#1f8f15]">AI</span> Powers Your Hiring Journey</h2>
              ...
              <Card className="border-0 shadow-sm h-full">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1f8f15] to-[#2d7a28] flex items-center justify-center">
                  ...
                  <div className="space-y-2">
                    {['Multi-dimensional skill scoring', 'Experience relevance weighting', 'Cultural fit analysis', 'Career trajectory prediction', 'Real-time score updates'].map((item, i) => (
                      <div key={i} className="flex items-center gap-2 text-sm">
                        <CheckCircle2 className="h-4 w-4 text-[#1f8f15] flex-shrink-0" />
      ...
      <section className="py-16 bg-gradient-to-br from-[#1f8f15] via-[#2d7a28] to-[#22c55e] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#c8e6c9]/80 mt-3 text-base max-w-xl mx-auto">Whether you&apos;re a job seeker looking for your next role or an employer seeking top talent — our AI tools are ready for you.</p>
