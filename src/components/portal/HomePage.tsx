...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ===== DOWNLOAD MOBILE APP ===== */}
      <section className="py-16 bg-gradient-to-b from-[#f0f8f0] to-white relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-72 h-72 bg-[#d8ecd8]/20 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#f26405]/5 rounded-full blur-3xl pointer-events-none" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left - App Info */}
            <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }}>
              <Badge className="bg-[#f0f8f0] text-[#014217] border-[#d8ecd8] rounded-full px-4 py-1 text-xs font-semibold mb-3">
                <Download className="h-3 w-3 mr-1" /> Free Download
              </Badge>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight">
                Get Jobs on the Go with <span className="bg-gradient-to-r from-[#014217] to-[#04a331] bg-clip-text text-transparent">3 Boxes App</span>
              </h2>
              <p className="text-gray-500 mt-4 text-sm leading-relaxed">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center justify-center bg-gradient-to-r from-[#014217] to-[#066722] hover:from-[#013514] hover:to-[#055519] text-white font-semibold px-6 h-12 rounded-xl shadow-lg shadow-[#04a331]/20 transition-all hover:shadow-xl hover:scale-[1.02]"
                >
                ...
                <a
                  ...
                  onClick={async (e) => {
                    ...
                    if (!installed && !isInstallable) {
                      toast.info('Add this site to your home screen for app-like experience! Use your browser menu → "Add to Home Screen"', { duration: 5000 });
                    }
                  }}
                  className="inline-flex items-center justify-center bg-gradient-to-r from-[#04a331] to-[#04a331] hover:from-[#038a29] hover:to-[#038a29] text-white font-semibold px-6 h-12 rounded-xl shadow-lg shadow-[#04a331]/20 transition-all hover:shadow-xl hover:scale-[1.02]"
                >
                  <Smartphone className="h-5 w-5 mr-2" /> Install as Web App
                </a>
                {/* iOS - Coming Soon */}
                <a
                  href="#"
                  onClick={(e) => { e.preventDefault(); toast.info('iOS app is coming soon to the App Store! For now, use Safari → Share → Add to Home Screen', { duration: 5000 }) }}
              ...
              <p className="text-xs text-gray-400 mt-3 flex items-center gap-1">
                <Smartphone className="h-3 w-3" /> Android 5.0+ required · 20 MB · Or install as PWA for instant access
              </p>
            </motion.div>
            ...
            <motion.div initial={{ x: 20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} className="flex justify-center">
              <div className="relative">
                ...
                <div className="w-[280px] h-[560px] bg-gray-900 rounded-[3rem] p-3 shadow-2xl relative">
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-[#014217] to-[#066722] rounded-[2.4rem] overflow-hidden relative">
                    {/* Status bar */}
