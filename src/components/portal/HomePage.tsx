...
const jobCategoriesConfig = [
  { icon: Code, label: 'IT & Software', count: '2,500+', keywords: ['React', 'Node', 'Python', 'AWS'], color: 'bg-[#014217]' },
  { icon: IndianRupee, label: 'Banking & Finance', count: '1,800+', keywords: ['CA', 'CFA', 'Accounting', 'Banking'], color: 'bg-[#066722]' },
  { icon: Heart, label: 'Healthcare', count: '950+', keywords: ['Doctor', 'Nurse', 'Pharma', 'Medical'], color: 'bg-[#046622]' },
  { icon: PenTool, label: 'Marketing', count: '1,200+', keywords: ['SEO', 'Content', 'Social Media', 'Brand'], color: 'bg-[#04a331]' },
  { icon: GraduationCap, label: 'Education', count: '780+', keywords: ['Teacher', 'Professor', 'Trainer', 'Curriculum'], color: 'bg-[#04a331]' },
  { icon: TrendingUp, label: 'Sales', count: '1,600+', keywords: ['B2B', 'B2C', 'Enterprise', 'SaaS'], color: 'bg-[#014217]' },
  { icon: Building2, label: 'Engineering', count: '1,100+', keywords: ['Civil', 'Mechanical', 'Electrical', 'Project Mgmt'], color: 'bg-[#066722]' },
  { icon: Cpu, label: 'Data Science', count: '900+', keywords: ['ML', 'AI', 'Analytics', 'Python'], color: 'bg-[#046622]' },
]
...
const howItWorksSteps = [
  { step: '01', icon: FileText, title: 'Create Profile', desc: 'Build your AI-powered resume with smart suggestions for skills, formats, and keywords recruiters search for.', color: 'from-[#014217] to-[#066722]' },
  { step: '02', icon: Brain, title: 'AI Matches Jobs', desc: 'Our intelligent engine analyzes your skills and preferences to surface the most relevant opportunities for you.', color: 'from-[#066722] to-[#014217]' },
  { step: '03', icon: Target, title: 'Practice Interviews', desc: 'Prepare with realistic AI mock interviews and get instant feedback on communication and technical depth.', color: 'from-[#046622] to-[#066722]' },
  { step: '04', icon: Trophy, title: 'Get Hired Faster', desc: 'With AI-enhanced resumes, verified skills, and interview readiness, you stand out to employers.', color: 'from-[#066722] to-[#014217]' },
]
...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-[#014217] via-[#066722] to-[#014217] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-14 sm:pb-20 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              >
                Find Your <span className="text-[#86efac]">Dream Job</span> with AI Precision
              </motion.h1>
              ...
              <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.3 }} className="mb-6">
                <div className="bg-white rounded-xl shadow-2xl p-2 sm:p-3">
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <Button className="h-12 px-8 bg-[#014217] hover:bg-[#066722] text-white font-semibold text-base rounded-lg whitespace-nowrap shadow-md"
                ...
                {[
                  ...
                  <div key={stat.label} className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg bg-white/15 flex items-center justify-center">
                      <stat.icon className="h-4 w-4 text-[#86efac]" />
                    </div>
                    <div>
            ...
            >
              <div className="relative">
                <div className="absolute -top-8 -left-8 w-72 h-72 bg-[#04a331]/20 rounded-full blur-3xl" />
                <div className="absolute -bottom-8 -right-8 w-64 h-64 bg-[#f26405]/10 rounded-full blur-3xl" />
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#014217]/60 via-transparent to-transparent" />
                  <div className="absolute bottom-5 left-5 right-5">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-[#014217] flex items-center justify-center flex-shrink-0">
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="w-9 h-9 rounded-lg bg-[#f26405]/15 flex items-center justify-center"><Trophy className="h-4 w-4 text-[#f26405]" /></div>
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="w-9 h-9 rounded-lg bg-[#014217]/15 flex items-center justify-center"><Brain className="h-4 w-4 text-[#014217]" /></div>
      ...
      <section className="py-12 sm:py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Top Companies <span className="text-[#014217]">Hiring Now</span></h2>
              <p className="text-sm text-gray-500 mt-1">Explore opportunities at India&apos;s leading organizations</p>
            </div>
            <Link href="/find-jobs" className="hidden sm:flex items-center gap-1 text-sm font-semibold text-[#014217] hover:underline">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {topCompanies.map((company, i) => (
              ...
              >
                <Card className="border border-gray-200 hover:border-[#04a331]/40 hover:shadow-md transition-all cursor-pointer group bg-white hover:-translate-y-0.5">
                  <CardContent className="p-4 flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-[#04a331] font-medium">{company.openings} jobs</p>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
          ...
          <div className="sm:hidden text-center mt-5">
            <Link href="/find-jobs" className="text-sm font-semibold text-[#014217] hover:underline">
      ...
      <section className="py-12 sm:py-16 bg-[#f0f8f0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <Badge className="bg-[#014217]/15 text-[#014217] border-0 rounded-full px-3 py-1 text-xs font-semibold mb-2">Explore Opportunities</Badge>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Browse Jobs by <span className="text-[#014217]">Category</span></h2>
            ...
            {jobCategoriesConfig.map((cat, i) => (
              ...
              >
                <Link href={`/find-jobs?search=${cat.keywords[0]}`}>
                  <Card className="border border-[#04a331]/20 bg-white hover:shadow-md hover:border-[#04a331]/40 transition-all cursor-pointer group h-full hover:-translate-y-0.5">
                    <CardContent className="p-4 flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-[#04a331] font-medium">{cat.count} jobs</p>
                      </div>
                    </CardContent>
                  </Card>
                </Link>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <Badge className="bg-[#014217]/15 text-[#014217] border-0 rounded-full px-3 py-1 text-xs font-semibold mb-2">Hand-Picked Opportunities</Badge>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Featured <span className="text-[#014217]">Jobs</span></h2>
              <p className="text-sm text-gray-600 mt-1">AI-matched opportunities for you</p>
            </div>
            <Link href="/find-jobs">
              <Button className="hidden sm:flex bg-[#014217] hover:bg-[#066722] text-white font-semibold text-sm rounded-lg h-10 px-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {displayJobs.map((job: any, i: number) => (
                <motion.div key={job.id || i} initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }}
                  transition={{ delay: i * 0.05 }} viewport={{ once: true }}
                >
                  <Card className="hover:-translate-y-1 transition-all duration-300 cursor-pointer group border border-gray-200 bg-white hover:shadow-lg hover:border-[#04a331]/30 overflow-hidden"
                    ...
                    <CardContent className="p-0">
                      <div className={`relative h-[100px] ${getCompanyColor(job.corporate?.companyName)} flex items-center justify-center`}>
                        ...
                        {job.isRemote && (
                          <label className="absolute top-3 left-3 bg-[#f26405] text-white text-[10px] font-semibold px-2 py-0.5 rounded-md uppercase tracking-wide shadow-sm">Remote</label>
                        )}
                        {i < 3 && !job.isRemote && (
                      ...
                      <div className="p-4">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge className="bg-[#014217]/10 text-[#014217] border-0 text-[10px] rounded-md px-2 py-0.5 font-medium capitalize flex-shrink-0 ml-auto">
                        ...
                        <div className="flex items-center justify-between pt-2.5 border-t border-gray-100">
                          ...
                          <Shield className="h-3.5 w-3.5 text-[#04a331]" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <div className="text-center mt-6 sm:hidden">
            <Link href="/find-jobs">
              <Button className="bg-[#014217] hover:bg-[#066722] text-white font-semibold px-8 h-10 rounded-lg">
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-br from-[#014217] via-[#066722] to-[#014217] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} className="text-center mb-10">
            <Badge className="bg-white/15 text-[#86efac] border-white/20 rounded-full px-3 py-1 text-xs font-semibold mb-2">Simple & Powerful</Badge>
            <h2 className="text-xl sm:text-2xl font-bold text-white">How <span className="text-[#86efac]">3BOXESJOBS</span> Works</h2>
                ...
                >
                  <Card className="border border-white/10 bg-white/10 backdrop-blur-sm hover:bg-white/15 transition-all h-full text-center group hover:-translate-y-1">
                    <CardContent className="p-5">
                      ...
                      <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center mx-auto mb-2">
                        <step.icon className="h-5 w-5 text-[#86efac]" />
                      </div>
                  ...
                  {i < 3 && (
                    <div className="hidden lg:flex absolute top-[40px] -right-4 z-20">
                      <div className="w-6 h-6 rounded-full bg-[#014217] shadow-md flex items-center justify-center border border-white/20">
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} className="text-center mb-10">
            <Badge className="bg-[#014217]/15 text-[#014217] border-0 rounded-full px-3 py-1 text-xs font-semibold mb-2">AI-Powered Platform</Badge>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Powered by <span className="text-[#014217]">AI</span></h2>
              ...
              <Card className="border border-gray-200 bg-white hover:shadow-xl transition-all h-full overflow-hidden group hover:-translate-y-1">
                <div className="relative h-[180px] overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="w-10 h-10 rounded-lg bg-[#014217]/90 flex items-center justify-center mb-2"><FileText className="h-5 w-5 text-white" /></div>
                ...
                <CardContent className="p-5">
                  ...
                  <Link href="/ai-features">
                    <Button className="w-full bg-[#014217] hover:bg-[#066722] text-white font-semibold rounded-lg h-10 text-sm">
            ...
            <motion.div initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} viewport={{ once: true }}>
              <Card className="border border-gray-200 bg-white hover:shadow-xl transition-all h-full overflow-hidden group hover:-translate-y-1">
                <div className="relative h-[180px] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/70 via-gray-900/30 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="w-10 h-10 rounded-lg bg-[#014217]/90 flex items-center justify-center mb-2"><Brain className="h-5 w-5 text-white" /></div>
            ...
            <motion.div initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} viewport={{ once: true }}>
              <Card className="border border-gray-200 bg-white hover:shadow-xl transition-all h-full overflow-hidden group hover:-translate-y-1">
                <div className="relative h-[180px] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/70 via-gray-900/30 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="w-10 h-10 rounded-lg bg-[#014217]/90 flex items-center justify-center mb-2"><Target className="h-5 w-5 text-white" /></div>
      ...
      <section className="py-12 sm:py-16 bg-[#f0f8f0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} className="text-center mb-10">
            <Badge className="bg-[#f26405]/15 text-[#f26405] border-0 rounded-full px-3 py-1 text-xs font-semibold mb-2">What People Say</Badge>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">What Our <span className="text-[#014217]">Users</span> Say</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {testimonials.map((t, i) => (
              ...
              >
                <Card className="border border-[#04a331]/20 bg-white hover:shadow-lg transition-all h-full hover:border-t-4 hover:border-t-[#f26405] group hover:-translate-y-1">
                  <CardContent className="p-5 relative">
                    <div className="absolute top-3 right-4 select-none" aria-hidden="true">
                      <span className="text-5xl font-serif leading-none text-[#014217] opacity-10">&ldquo;</span>
                    </div>
                    <div className="flex items-center gap-0.5 mb-3">
                      {Array.from({ length: t.rating }).map((_, j) => (
                        <Star key={j} className="h-3.5 w-3.5 fill-[#f26405] text-[#f26405]" />
                      ))}
                    </div>
                    <p className="text-sm text-gray-600 leading-relaxed mb-4 relative z-10">&ldquo;{t.text}&rdquo;</p>
                    <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
                      <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#014217] via-[#04a331] to-[#f26405] flex items-center justify-center text-white font-bold text-xs shadow-sm">
                        {t.avatar}
                      </div>
                      <div>
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-br from-[#014217] via-[#066722] to-[#014217] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }}>
            <div className="bg-gradient-to-br from-[#013b0b] via-[#014217] to-[#013b0b] rounded-2xl overflow-hidden relative border border-white/10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                {/* Left: CTA Text */}
                <div className="p-8 sm:p-12 relative z-10">
                  <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-5">
                    <Rocket className="h-4 w-4 text-[#86efac]" />
                  ...
                  <div className="flex flex-wrap justify-start gap-3">
                    <Link href="/register">
                      <Button className="bg-white text-[#014217] hover:bg-gray-100 font-bold px-7 h-11 text-sm rounded-lg shadow-lg">
                        <UserCheck className="h-4 w-4 mr-2" /> Register Free
                      </Button>
                    </Link>
                    <Link href="/login">
                      <Button className="bg-[#f26405] hover:bg-[#e85a05] text-[#202124] font-bold px-7 h-11 text-sm rounded-lg shadow-lg">
