      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-blue-50/15 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left - App Info */}
            <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }}>
              <Badge className="bg-[#f0f8f0] text-[#056022] border-[#d8ecd8] rounded-full px-4 py-1 text-xs font-semibold mb-3">
                Free Download
              </Badge>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight">
                Get Jobs on the Go with <span className="bg-gradient-to-r from-[#056022] to-[#7c66ff] bg-clip-text text-transparent">3 Boxes App</span>
              </h2>
              <p className="text-gray-500 mt-4 text-sm leading-relaxed">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center justify-center bg-gradient-to-r from-[#056022] to-[#056022] hover:from-[#044d1a] hover:to-[#044d1a] text-white font-semibold px-6 h-12 rounded-xl shadow-lg shadow-green-200/50 transition-all hover:shadow-xl hover:scale-[1.02]"
                >
            ...
            <motion.div initial={{ x: 20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} className="flex justify-center">
              <div className="relative">
                ...
                <div className="w-[280px] h-[560px] bg-gray-900 rounded-[3rem] p-3 shadow-2xl relative">
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-[#056022] to-[#044d1a] rounded-[2.4rem] overflow-hidden relative">
                    {/* Status bar */}
