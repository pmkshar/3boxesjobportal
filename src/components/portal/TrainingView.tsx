    ...
    <div className="space-y-4">
      ...
      <Card className="bg-gradient-to-r from-emerald-50 to-green-50 border-emerald-200">
        <CardContent className="p-4 flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1f8f15] to-[#2d7a28] flex items-center justify-center flex-shrink-0">
          ...
          <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer">
            <Button size="sm" className="bg-[#1f8f15] hover:bg-[#2d7a28] text-white font-semibold rounded-lg text-xs">
      ...
      <div className="text-center pt-4">
        <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#1f8f15] hover:text-[#2d7a28] font-semibold text-sm">
