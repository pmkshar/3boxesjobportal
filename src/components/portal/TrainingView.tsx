    ...
    <div className="space-y-4">
      ...
      <Card className="bg-gradient-to-r from-emerald-50 to-green-50 border-emerald-200">
        <CardContent className="p-4 flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#056022] to-[#044d1a] flex items-center justify-center flex-shrink-0">
          ...
          <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer">
            <Button size="sm" className="bg-[#056022] hover:bg-[#044d1a] text-white font-semibold rounded-lg text-xs">
      ...
      <div className="text-center pt-4">
        <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#056022] hover:text-[#044d1a] font-semibold text-sm">
