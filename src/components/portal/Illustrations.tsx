  ...
  return (
    ...
    >
      <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Desk */}
        <rect x="80" y="180" width="240" height="8" rx="4" fill="#066722" />
        <rect x="90" y="188" width="10" height="60" rx="2" fill="#014217" />
        <rect x="300" y="188" width="10" height="60" rx="2" fill="#014217" />

        {/* Laptop */}
        <rect x="140" y="130" width="120" height="50" rx="4" fill="#e2e8f0" stroke="#014217" strokeWidth="2" />
        <rect x="148" y="136" width="104" height="36" rx="2" fill="#f0fdf4" />
        {/* Screen content */}
        <rect x="155" y="142" width="40" height="4" rx="2" fill="#014217" opacity="0.6" />
        ...
        {/* Body */}
        <path d="M185 112 L180 130 L175 175" stroke="#014217" strokeWidth="8" strokeLinecap="round" fill="none" />
        <path d="M215 112 L220 130 L225 175" stroke="#014217" strokeWidth="8" strokeLinecap="round" fill="none" />
        ...
        <motion.g animate={{ y: [-5, 5, -5] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
          {/* Brain/AI icon */}
          <circle cx="330" cy="100" r="18" fill="#dcfce7" stroke="#014217" strokeWidth="2" />
          <path d="M322 100 Q326 90 330 95 Q334 90 338 100 Q338 108 330 112 Q322 108 322 100Z" fill="#014217" opacity="0.7" />
        </motion.g>
        ...
        <motion.g animate={{ y: [5, -5, 5] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut" }}>
          ...
          <circle cx="70" cy="140" r="8" fill="none" stroke="#014217" strokeWidth="1.5" />
          <circle cx="70" cy="140" r="3" fill="#014217" />
        </motion.g>

        <motion.g animate={{ y: [-3, 7, -3] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}>
          {/* Chart icon */}
          <rect x="340" y="150" width="30" height="30" rx="6" fill="#dcfce7" stroke="#014217" strokeWidth="2" />
          <rect x="347" y="165" width="4" height="10" rx="1" fill="#22c55e" />
          <rect x="353" y="158" width="4" height="17" rx="1" fill="#014217" />
    ...
    >
      <svg viewBox="0 0 300 250" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <motion.g animate={{ scale: [1, 1.05, 1] }} transition={{ duration: 2, repeat: Infinity }}>
          <circle cx="150" cy="110" r="28" fill="#014217" />
        ...
        {[
          ...
          <motion.g key={i} animate={{ y: [0, -3, 0] }} transition={{ duration: 2 + i * 0.3, repeat: Infinity, delay: i * 0.2 }}>
            <circle cx={pos.cx} cy={pos.cy} r="18" fill="#dcfce7" stroke="#014217" strokeWidth="2" />
            <circle cx={pos.cx} cy={pos.cy - 4} r="6" fill="#fcd34d" />
            <path d={`M${pos.cx - 5} ${pos.cy + 5} L${pos.cx} ${pos.cy + 2} L${pos.cx + 5} ${pos.cy + 5}`} fill="#014217" opacity="0.6" />
          </motion.g>
        ))}
        ...
        {/* Label */}
        <text x="150" y="240" textAnchor="middle" fill="#014217" fontSize="12" fontWeight="600">AI-Powered Matching</text>
      </svg>
    </motion.div>
  )
}
  ...
  return (
    ...
    >
      <svg viewBox="0 0 250 280" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Document */}
        <rect x="40" y="20" width="170" height="230" rx="8" fill="white" stroke="#014217" strokeWidth="2" />
        {/* Header */}
        <rect x="55" y="35" width="80" height="8" rx="4" fill="#014217" opacity="0.8" />
        <rect x="55" y="50" width="140" height="4" rx="2" fill="#dcfce7" />
        <rect x="55" y="58" width="120" height="4" rx="2" fill="#dcfce7" />

        {/* Profile circle */}
        <circle cx="180" cy="45" r="15" fill="#dcfce7" stroke="#014217" strokeWidth="1.5" />
        <circle cx="180" cy="41" r="5" fill="#fcd34d" />
        <path d="M172 52 Q180 56 188 52" fill="#014217" opacity="0.5" />

        {/* Section: Experience */}
        <rect x="55" y="75" width="60" height="5" rx="2.5" fill="#22c55e" opacity="0.7" />
        <rect x="55" y="86" width="3" height="20" rx="1.5" fill="#014217" />
        ...
        <rect x="55" y="112" width="3" height="20" rx="1.5" fill="#014217" />
        ...
        <rect x="55" y="153" width="35" height="14" rx="7" fill="#dcfce7" stroke="#014217" strokeWidth="1" />
        <text x="72" y="163" textAnchor="middle" fill="#014217" fontSize="8" fontWeight="500">React</text>
        <rect x="95" y="153" width="32" height="14" rx="7" fill="#dcfce7" stroke="#014217" strokeWidth="1" />
        <text x="111" y="163" textAnchor="middle" fill="#014217" fontSize="8" fontWeight="500">Node</text>
        <rect x="132" y="153" width="45" height="14" rx="7" fill="#dcfce7" stroke="#014217" strokeWidth="1" />
        <text x="155" y="163" textAnchor="middle" fill="#014217" fontSize="8" fontWeight="500">Python</text>
        <rect x="55" y="172" width="28" height="14" rx="7" fill="#dcfce7" stroke="#014217" strokeWidth="1" />
        <text x="69" y="182" textAnchor="middle" fill="#014217" fontSize="8" fontWeight="500">AWS</text>
        <rect x="88" y="172" width="38" height="14" rx="7" fill="#dcfce7" stroke="#014217" strokeWidth="1" />
        <text x="107" y="182" textAnchor="middle" fill="#014217" fontSize="8" fontWeight="500">Docker</text>
        ...
        {/* Auto-update arrow */}
        <motion.path d="M215 160 C230 140 230 120 215 100" stroke="#014217" strokeWidth="2" fill="none"
        ...
        <path d="M210 95 L215 85 L220 95" fill="#014217" />
        <path d="M210 225 L215 235 L220 225" fill="#86efac" />

        {/* Label */}
        <text x="125" y="270" textAnchor="middle" fill="#014217" fontSize="11" fontWeight="600">AI Resume Builder</text>
      </svg>
    </motion.div>
  )
}
  ...
  return (
    ...
    >
      <svg viewBox="0 0 280 260" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Video call frame */}
        <rect x="20" y="20" width="240" height="160" rx="12" fill="#1e293b" stroke="#014217" strokeWidth="2" />
        {/* Screen content */}
        ...
        <rect x="35" y="35" width="80" height="60" rx="6" stroke="#014217" strokeWidth="1" fill="none" opacity="0.3" />

        {/* Candidate (larger) */}
        <rect x="130" y="35" width="115" height="85" rx="6" fill="#1e293b" stroke="#334155" strokeWidth="1" />
        <circle cx="188" cy="60" r="14" fill="#fcd34d" />
        <path d="M168 80 Q188 90 208 80" fill="#014217" opacity="0.7" />
        <rect x="130" y="35" width="115" height="85" rx="6" stroke="#22c55e" strokeWidth="1.5" fill="none" opacity="0.4" />

        {/* AI feedback panel */}
        <rect x="35" y="105" width="80" height="60" rx="6" fill="#0f172a" stroke="#014217" strokeWidth="1" />
        ...
        <rect x="42" y="144" width="40" height="4" rx="2" fill="#014217" />
        ...
        <motion.g animate={{ y: [-5, 5, -5] }} transition={{ duration: 3, repeat: Infinity }}>
          <rect x="210" y="130" width="40" height="24" rx="12" fill="#014217" />
          <text x="230" y="146" textAnchor="middle" fill="white" fontSize="10" fontWeight="700">85%</text>
        </motion.g>

        {/* Bottom icons */}
        <circle cx="100" cy="200" r="14" fill="#dcfce7" stroke="#014217" strokeWidth="1.5" />
        <path d="M94 200 L98 204 L106 196" stroke="#014217" strokeWidth="2" strokeLinecap="round" fill="none" />
        <circle cx="140" cy="200" r="14" fill="#dcfce7" stroke="#014217" strokeWidth="1.5" />
        <path d="M134 196 L140 204 L146 196 M134 200 L140 208 L146 200" stroke="#014217" strokeWidth="1.5" strokeLinecap="round" fill="none" />
        <circle cx="180" cy="200" r="14" fill="#dcfce7" stroke="#014217" strokeWidth="1.5" />
        <rect x="175" y="195" width="10" height="10" rx="2" stroke="#014217" strokeWidth="1.5" fill="none" />

        {/* Label */}
        <text x="140" y="245" textAnchor="middle" fill="#014217" fontSize="11" fontWeight="600">AI Mock Interviews</text>
      </svg>
    </motion.div>
  )
}
  ...
  return (
    ...
    >
      <svg viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <motion.circle cx="130" cy="110" r="70" fill="none" stroke="#014217" strokeWidth="8"
        ...
        <text x="130" y="105" textAnchor="middle" fill="#014217" fontSize="18" fontWeight="700">78</text>
        <text x="130" y="118" textAnchor="middle" fill="#86efac" fontSize="7" fontWeight="500">SKILL SCORE</text>

        {/* Skill tags floating around */}
        {[
          { x: 30, y: 50, label: 'React', color: '#014217' },
          { x: 200, y: 40, label: 'Node.js', color: '#22c55e' },
          { x: 20, y: 170, label: 'AWS', color: '#066722' },
          { x: 210, y: 160, label: 'Python', color: '#014217' },
        ...
        {/* Auto-update arrows */}
        <motion.path d="M130 200 L130 220" stroke="#014217" strokeWidth="2" fill="none"
          strokeDasharray="3 3" animate={{ strokeDashoffset: [0, 6] }} transition={{ duration: 0.8, repeat: Infinity }} />
        <path d="M125 215 L130 225 L135 215" fill="#014217" />

        {/* Update badge */}
        <motion.rect x="95" y="228" width="70" height="20" rx="10" fill="#014217"
          animate={{ scale: [1, 1.05, 1] }} transition={{ duration: 2, repeat: Infinity }} />
        <text x="130" y="242" textAnchor="middle" fill="white" fontSize="8" fontWeight="600">AUTO-UPDATE</text>

        {/* Label */}
        <text x="130" y="258" textAnchor="middle" fill="#014217" fontSize="11" fontWeight="600">Skills & Training</text>
      </svg>
    </motion.div>
  )
}
  ...
  return (
    ...
    >
      <svg viewBox="0 0 280 220" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <motion.rect x="110" y="70" width="20" height="100" rx="4" fill="#014217"
          animate={{ height: [0, 100], y: [170, 70] }} transition={{ duration: 0.5, delay: 0.6 }} />
        <motion.rect x="140" y="55" width="20" height="115" rx="4" fill="#066722"
          animate={{ height: [0, 115], y: [170, 55] }} transition={{ duration: 0.5, delay: 0.8 }} />
        <motion.rect x="170" y="40" width="20" height="130" rx="4" fill="#014217"
          animate={{ height: [0, 130], y: [170, 40] }} transition={{ duration: 0.5, delay: 1.0 }} />
        <motion.rect x="200" y="30" width="20" height="140" rx="4" fill="#066722"
        ...
        <motion.g animate={{ rotate: 360 }} transition={{ duration: 6, repeat: Infinity, ease: "linear" }}>
          <path d="M240 45 L243 38 L246 45 L253 48 L246 51 L243 58 L240 51 L233 48 Z" fill="#014217" opacity="0.6" />
        </motion.g>
        ...
        {/* Bottom label */}
        <text x="140" y="210" textAnchor="middle" fill="#014217" fontSize="11" fontWeight="600">Career Growth Analytics</text>
      </svg>
    </motion.div>
  )
}
  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="52" y="72" width="26" height="35" rx="8" fill="#014217" />
        ...
        <motion.g animate={{ y: [0, -3, 0] }} transition={{ duration: 2, repeat: Infinity }}>
          ...
          <path d="M78 88 Q100 95 122 88" stroke="#014217" strokeWidth="4" strokeLinecap="round" fill="none" />
        </motion.g>
        ...
        {/* Bottom label */}
        <text x="100" y="130" textAnchor="middle" fill="#014217" fontSize="10" fontWeight="600">Trusted by 5,000+ Companies</text>
      </svg>
    </motion.div>
  )
}
