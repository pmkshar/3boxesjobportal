...
const COLORS = ['#024217', '#0d9488', '#0891b2', '#d97706', '#7c3aed', '#e11d48', '#ea5703']
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={skillData}>
                  ...
                  <Tooltip />
                  <Bar dataKey="level" fill="#024217" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={interviewData}>
                  ...
                  <YAxis tick={{ fontSize: 10 }} />
                  <Tooltip />
                  <Line type="monotone" dataKey="overall" stroke="#024217" strokeWidth={2} name="Overall" />
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={250}>
                <RadarChart data={radarData}>
                  ...
                  <Radar name="Skills" dataKey="level" stroke="#024217" fill="#024217" fillOpacity={0.2} />
                </RadarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
