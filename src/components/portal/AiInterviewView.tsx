...
export function AiInterviewView() {
  ...
  const getRecommendationStyle = (rec: string) => {
    switch (rec) {
      case 'Strong Hire': return { bg: '#d8ecd8', text: '#056022', icon: <ThumbsUp className="h-4 w-4" /> }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Completed', value: dashboardStats.completed, icon: CheckCircle2, color: '#fc7e0b' },
