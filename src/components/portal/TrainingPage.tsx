...
const courses = [
  ...
  },
  {
    ...
    icon: Star,
    gradient: 'from-[#045a06] to-[#034604]',
  },
]
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Learn Software with <span className="text-[#3a9a48]">AI Voice Tutoring</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="bg-[#f0faf2] text-[#045a06] border-[#d1e8d5] rounded-full px-4 py-1 text-xs font-semibold mb-3">From MarqAI Courses</Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Courses Available on <span className="text-[#045a06]">marqaicourses.com</span></h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }}>
              <Badge className="bg-[#f0faf2] text-[#045a06] border-[#d1e8d5] rounded-full px-4 py-1 text-xs font-semibold mb-3">Why Train With Us</Badge>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight">
                Complete a Course, <span className="text-[#045a06]">Boost Your Career</span> Automatically
              </h2>
              ...
              <Card className="border-0 shadow-lg overflow-hidden">
                <CardContent className="p-0">
                  ...
                  <div className="p-6 space-y-0">
                    {[
                      { step: '1', icon: BookOpen, title: 'Enroll in a Course', desc: 'Choose from 8 career-track courses on MarqAI Courses', color: 'bg-[#045a06]', line: true },
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: BookOpen, value: '8', label: 'Career Track Courses', color: 'text-[#045a06]' },
              ...
              { icon: TrendingUp, value: '3X', label: 'More Interview Calls', color: 'text-[#034604]' },
            ].map((stat, i) => (
      ...
      <section className="py-16 bg-gradient-to-br from-[#023303] via-[#034604] to-[#22c55e] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <GraduationCap className="h-12 w-12 text-[#3a9a48] mx-auto mb-4" />
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white">Start Learning Today on MarqAI Courses</h2>
          <p className="text-[#d1e8d5]/80 mt-3 text-base max-w-xl mx-auto">Every course you complete makes your profile stronger, your match scores higher, and your career opportunities broader. Start now — it&apos;s free.</p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer">
              <Button className="bg-[#fa7903] hover:bg-[#3a9a48] text-green-900 font-bold px-8 h-12 text-base rounded-xl shadow-lg">
