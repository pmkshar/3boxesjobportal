...
const courses = [
  ...
  },
  {
    ...
    icon: Star,
    gradient: 'from-[#014217] to-[#066722]',
  },
]
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Learn Software with <span className="text-[#04a331]">AI Voice Tutoring</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="bg-[#f0f8f0] text-[#014217] border-[#d8ecd8] rounded-full px-4 py-1 text-xs font-semibold mb-3">From MarqAI Courses</Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Courses Available on <span className="text-[#014217]">marqaicourses.com</span></h2>
                ...
                <Card className="border-0 shadow-sm h-full hover:shadow-lg transition-all group overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    ...
                    <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer" className="block">
                      <Button size="sm" className="w-full bg-[#014217] hover:bg-[#066722] text-white font-semibold rounded-lg text-xs">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }}>
              <Badge className="bg-[#f0f8f0] text-[#014217] border-[#d8ecd8] rounded-full px-4 py-1 text-xs font-semibold mb-3">Why Train With Us</Badge>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight">
                Complete a Course, <span className="text-[#014217]">Boost Your Career</span> Automatically
              </h2>
      ...
      <section className="py-16 bg-gradient-to-br from-[#014217] via-[#066722] to-[#22c55e] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <GraduationCap className="h-12 w-12 text-[#04a331] mx-auto mb-4" />
