...
const courses = [
  ...
  },
  {
    ...
    icon: Star,
    gradient: 'from-[#1f8f15] to-[#2d7a28]',
  },
]
...
export function TrainingPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* ===== HERO BANNER ===== */}
      <section className="relative bg-gradient-to-br from-[#1f8f15] via-[#2d7a28] to-[#22c55e] py-16 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Learn Software with <span className="text-[#49A842]">AI Voice Tutoring</span>
            </h1>
            <p className="text-[#c8e6c9]/80 mt-4 text-base sm:text-lg max-w-2xl mx-auto">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer">
                <Button className="bg-[#fc7e0b] hover:bg-[#49A842] text-green-900 font-bold px-8 h-12 text-base rounded-xl shadow-lg">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <Badge className="bg-[#e8f5e9] text-[#1f8f15] border-[#c8e6c9] rounded-full px-4 py-1 text-xs font-semibold mb-3">From MarqAI Courses</Badge>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Courses Available on <span className="text-[#1f8f15]">marqaicourses.com</span></h2>
                ...
                <Card className="border-0 shadow-sm h-full hover:shadow-lg transition-all group overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    ...
                    <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer" className="block">
                      <Button size="sm" className="w-full bg-[#1f8f15] hover:bg-[#2d7a28] text-white font-semibold rounded-lg text-xs">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ x: -20, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }}>
              <Badge className="bg-[#e8f5e9] text-[#1f8f15] border-[#c8e6c9] rounded-full px-4 py-1 text-xs font-semibold mb-3">Why Train With Us</Badge>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight">
                Complete a Course, <span className="text-[#1f8f15]">Boost Your Career</span> Automatically
              </h2>
              ...
              <Card className="border-0 shadow-lg overflow-hidden">
                <CardContent className="p-0">
                  ...
                  <div className="p-6 space-y-0">
                    {[
                      { step: '1', icon: BookOpen, title: 'Enroll in a Course', desc: 'Choose from 8 career-track courses on MarqAI Courses', color: 'bg-[#1f8f15]', line: true },
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: BookOpen, value: '8', label: 'Career Track Courses', color: 'text-[#1f8f15]' },
              ...
              { icon: TrendingUp, value: '3X', label: 'More Interview Calls', color: 'text-[#2d7a28]' },
            ].map((stat, i) => (
      ...
      {/* ===== CTA SECTION ===== */}
      <section className="py-16 bg-gradient-to-br from-[#1f8f15] via-[#2d7a28] to-[#22c55e] relative overflow-hidden">
        <div className="absolute inset-0 opacity-10" style={{backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23ffffff\' fill-opacity=\'0.4\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")'}} />
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <GraduationCap className="h-12 w-12 text-[#49A842] mx-auto mb-4" />
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white">Start Learning Today on MarqAI Courses</h2>
          <p className="text-[#c8e6c9]/80 mt-3 text-base max-w-xl mx-auto">Every course you complete makes your profile stronger, your match scores higher, and your career opportunities broader. Start now — it&apos;s free.</p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a href={MARQAICOURSES_URL} target="_blank" rel="noopener noreferrer">
              <Button className="bg-[#fc7e0b] hover:bg-[#49A842] text-green-900 font-bold px-8 h-12 text-base rounded-xl shadow-lg">
